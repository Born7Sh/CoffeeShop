           ...
           public void onResponse(Call<List<ComCafeData>> call, Response<List<ComCafeData>> response){
               if(response.isSuccessful()){
                   ...
                   for(int i=0;i<re1.size();i++){
                       listCafeData.add(new CafeData(re1.get(i).cafe_name,re1.get(i).start_time,re1.get(i).end_time,String.valueOf(re1.get(i).star),re1.get(i).id,re1.get(i).x,re1.get(i).y,re1.get(i).phone,re1.get(i).notice,re1.get(i).seat_total));
                   }
