                                     ...
                                     call2.enqueue(new Callback<ComCafeData>() {
                                         ...
                                         public void onResponse(Call<ComCafeData> call2, Response<ComCafeData> response2) {
                                                     if (response2.isSuccessful()) {
                                                         ...
                                                         cafedata1.add(new CafeData(re2.cafe_name, re2.start_time, re2.end_time, String.valueOf(re2.star),
                                                                 re2.id, re2.x, re2.y, re2.phone, re2.notice,re2.seat_total,re2.business,re2.tag1,re2.tag2));
                                    ...
                                    call2.enqueue(new Callback<ComCafeData>() {
                                        ...
                                        public void onResponse(Call<ComCafeData> call2, Response<ComCafeData> response2) {
                                            if (response2.isSuccessful()) {
                                                ...
                                                cafedata1.add(new CafeData(re2.cafe_name, re2.start_time, re2.end_time, String.valueOf(re2.star), re2.id,
                                                        re2.x, re2.y, re2.phone, re2.notice,re2.seat_total,re2.business,re2.tag1,re2.tag2));
